...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`
        fixed left-0 top-0 h-full w-64 bg-gray-50 border-r border-b border-gray-200 z-50 transform transition-transform duration-300 ease-in-out
            ...
            {menuItems.map((item, index) => (
              <a
                ...
                className={`
                  ...
                  ${
                    item.active
                      ? "bg-gray-200 text-blue-700 border-r-2 border-gray-400"
